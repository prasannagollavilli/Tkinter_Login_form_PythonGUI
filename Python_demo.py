...
# added pading
text_label = tk.Label(root, text='Flipkart', font=("Arial", 16), 
                      fg='white', bg='#0096DC')
text_label.pack()

email_label = tk.Label(root, text='Enter email', 
                       font=("Arial", 16), fg='white', bg='#0096DC')
email_label.pack(fill="x")

email_input = tk.Entry(root, width=50)
email_input.pack()

pass_label = tk.Label(root, text='Enter pwd', 
                      font=("Arial", 16), fg='white', bg='#0096DC')
...
Login_btn = tk.Button(root,text='Login here', 
                      bg='white', fg='black', command=handle_login)
